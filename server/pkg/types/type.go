...
type StoreAppConfig struct {
	...
	LaunchUIValues      map[string]string `json:"launchUIValues,omitempty"`
}
...
type AppConfig struct {
	...
	LaunchUIValues      map[string]string `cql:"launch_ui_values" json:"launch_ui_values"`
	OverrideValues      map[string]string `cql:"override_values" json:"override_values"`
}
