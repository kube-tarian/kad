...
type StoreAppConfig struct {
	...
	OverrideValues      []byte `json:"overrideValues,omitempty"`
	LaunchUIValues      []byte `json:"launchUIValues,omitempty"`
}
...
type AppConfig struct {
	...
	Icon                []byte    `cql:"icon" json:"icon"`
	Description         string    `cql:"description" json:"description"`
	LaunchUIValues      []byte    `cql:"launch_ui_values" json:"launch_ui_values"`
	OverrideValues      []byte    `cql:"override_values" json:"override_values"`
}
