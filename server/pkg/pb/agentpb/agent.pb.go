...
var file_agent_proto_rawDesc = []byte{
	...
	0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x77, 0x0a, 0x11, 0x55,
	...
	0x6c, 0x75, 0x65, 0x73, 0x22, 0x67, 0x0a, 0x12, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x41,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x62, 0x0a,
	0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x70, 0x70, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x72, 0x65, 0x6c, 0x65, 0x61,
	0x73, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x72, 0x65,
	0x6c, 0x65, 0x61, 0x73, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x6f, 0x76, 0x65,
	...
	0x73, 0x22, 0x6c, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x70, 0x70, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b, 0x0a, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x61,
	0x67, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64,
	0x65, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x24, 0x0a, 0x0d, 0x73, 0x74, 0x61,
	...
	0xe7, 0x0b, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x38, 0x0a, 0x09, 0x53, 0x75, 0x62,
...
var file_agent_proto_goTypes = []interface{}{
	...
	(*UpdateAppValuesRequest)(nil),         // 36: agentpb.UpdateAppValuesRequest
	(*UpdateAppValuesResponse)(nil),        // 37: agentpb.UpdateAppValuesResponse
	nil,                                    // 38: agentpb.StoreCredentialRequest.CredentialEntry
	(*any1.Any)(nil),                       // 39: google.protobuf.Any
}
var file_agent_proto_depIdxs = []int32{
	0,  // 0: agentpb.PingResponse.status:type_name -> agentpb.StatusCode
	38, // 1: agentpb.StoreCredentialRequest.credential:type_name -> agentpb.StoreCredentialRequest.CredentialEntry
	0,  // 2: agentpb.StoreCredentialResponse.status:type_name -> agentpb.StatusCode
	39, // 3: agentpb.JobRequest.payload:type_name -> google.protobuf.Any
	...
	0,  // 24: agentpb.UpdateAppValuesResponse.status:type_name -> agentpb.StatusCode
	10, // 25: agentpb.Agent.SubmitJob:input_type -> agentpb.JobRequest
	5,  // 26: agentpb.Agent.ClusterAdd:input_type -> agentpb.ClusterRequest
	5,  // 27: agentpb.Agent.ClusterDelete:input_type -> agentpb.ClusterRequest
	6,  // 28: agentpb.Agent.RepositoryAdd:input_type -> agentpb.RepositoryAddRequest
	7,  // 29: agentpb.Agent.RepositoryDelete:input_type -> agentpb.RepositoryDeleteRequest
	8,  // 30: agentpb.Agent.ProjectAdd:input_type -> agentpb.ProjectAddRequest
	9,  // 31: agentpb.Agent.ProjectDelete:input_type -> agentpb.ProjectDeleteRequest
	1,  // 32: agentpb.Agent.Ping:input_type -> agentpb.PingRequest
	3,  // 33: agentpb.Agent.StoreCredential:input_type -> agentpb.StoreCredentialRequest
	12, // 34: agentpb.Agent.SyncApp:input_type -> agentpb.SyncAppRequest
	14, // 35: agentpb.Agent.GetClusterApps:input_type -> agentpb.GetClusterAppsRequest
	16, // 36: agentpb.Agent.GetClusterAppLaunches:input_type -> agentpb.GetClusterAppLaunchesRequest
	18, // 37: agentpb.Agent.ConfigureAppSSO:input_type -> agentpb.ConfigureAppSSORequest
	20, // 38: agentpb.Agent.GetClusterAppConfig:input_type -> agentpb.GetClusterAppConfigRequest
	22, // 39: agentpb.Agent.GetClusterAppValues:input_type -> agentpb.GetClusterAppValuesRequest
	24, // 40: agentpb.Agent.GetClusterGlobalValues:input_type -> agentpb.GetClusterGlobalValuesRequest
	26, // 41: agentpb.Agent.InstallApp:input_type -> agentpb.InstallAppRequest
	34, // 42: agentpb.Agent.UpgradeApp:input_type -> agentpb.UpgradeAppRequest
	36, // 43: agentpb.Agent.UpdateAppValues:input_type -> agentpb.UpdateAppValuesRequest
	11, // 44: agentpb.Agent.SubmitJob:output_type -> agentpb.JobResponse
	11, // 45: agentpb.Agent.ClusterAdd:output_type -> agentpb.JobResponse
	11, // 46: agentpb.Agent.ClusterDelete:output_type -> agentpb.JobResponse
	11, // 47: agentpb.Agent.RepositoryAdd:output_type -> agentpb.JobResponse
	11, // 48: agentpb.Agent.RepositoryDelete:output_type -> agentpb.JobResponse
	11, // 49: agentpb.Agent.ProjectAdd:output_type -> agentpb.JobResponse
	11, // 50: agentpb.Agent.ProjectDelete:output_type -> agentpb.JobResponse
	2,  // 51: agentpb.Agent.Ping:output_type -> agentpb.PingResponse
	4,  // 52: agentpb.Agent.StoreCredential:output_type -> agentpb.StoreCredentialResponse
	13, // 53: agentpb.Agent.SyncApp:output_type -> agentpb.SyncAppResponse
	15, // 54: agentpb.Agent.GetClusterApps:output_type -> agentpb.GetClusterAppsResponse
	17, // 55: agentpb.Agent.GetClusterAppLaunches:output_type -> agentpb.GetClusterAppLaunchesResponse
	19, // 56: agentpb.Agent.ConfigureAppSSO:output_type -> agentpb.ConfigureAppSSOResponse
	21, // 57: agentpb.Agent.GetClusterAppConfig:output_type -> agentpb.GetClusterAppConfigResponse
	23, // 58: agentpb.Agent.GetClusterAppValues:output_type -> agentpb.GetClusterAppValuesResponse
	25, // 59: agentpb.Agent.GetClusterGlobalValues:output_type -> agentpb.GetClusterGlobalValuesResponse
	27, // 60: agentpb.Agent.InstallApp:output_type -> agentpb.InstallAppResponse
	35, // 61: agentpb.Agent.UpgradeApp:output_type -> agentpb.UpgradeAppResponse
	37, // 62: agentpb.Agent.UpdateAppValues:output_type -> agentpb.UpdateAppValuesResponse
