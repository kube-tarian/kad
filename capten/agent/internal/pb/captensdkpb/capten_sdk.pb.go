...
func (x *SetupDatabaseRequest) Reset() {
	*x = SetupDatabaseRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetupDatabaseRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetupDatabaseRequest) ProtoMessage() {}

func (x *SetupDatabaseRequest) ProtoReflect() protoreflect.Message {
	mi := &file_capten_sdk_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetupDatabaseRequest.ProtoReflect.Descriptor instead.
func (*SetupDatabaseRequest) Descriptor() ([]byte, []int) {
	return file_capten_sdk_proto_rawDescGZIP(), []int{6}
}

func (x *SetupDatabaseRequest) GetPluginName() string {
	if x != nil {
		return x.PluginName
	}
	return ""
...
func (x *SetupDatabaseRequest) GetDbOemName() string {
	if x != nil {
		return x.DbOemName
	}
	return ""
...
func (x *SetupDatabaseRequest) GetDbName() string {
	if x != nil {
		return x.DbName
	}
	return ""
...
func (x *SetupDatabaseRequest) GetServiceUserName() string {
	if x != nil {
...
type SetupDatabaseResponse struct {
	...
	SvcUserCredentialsPathInVault string     `protobuf:"bytes,3,opt,name=svcUserCredentialsPathInVault,proto3" json:"svcUserCredentialsPathInVault,omitempty"`
}

func (x *SetupDatabaseResponse) Reset() {
	*x = SetupDatabaseResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetupDatabaseResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetupDatabaseResponse) ProtoMessage() {}

func (x *SetupDatabaseResponse) ProtoReflect() protoreflect.Message {
	mi := &file_capten_sdk_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetupDatabaseResponse.ProtoReflect.Descriptor instead.
func (*SetupDatabaseResponse) Descriptor() ([]byte, []int) {
	return file_capten_sdk_proto_rawDescGZIP(), []int{7}
}

func (x *SetupDatabaseResponse) GetStatus() StatusCode {
	if x != nil {
		return x.Status
	}
	return StatusCode_OK
...
func (x *SetupDatabaseResponse) GetStatusMessage() string {
	if x != nil {
		return x.StatusMessage
	}
	return ""
...
func (x *SetupDatabaseResponse) GetSvcUserCredentialsPathInVault() string {
	if x != nil {
		return x.SvcUserCredentialsPathInVault
	}
	return ""
}
...
var file_capten_sdk_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x96, 0x01, 0x0a, 0x14, 0x53,
	0x65, 0x74, 0x75, 0x70, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x73, 0x61, 0x67, 0x65, 0x12, 0x44, 0x0a, 0x1d, 0x73, 0x76, 0x63, 0x55, 0x73, 0x65, 0x72, 0x43,
	0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x50, 0x61, 0x74, 0x68, 0x49, 0x6e,
	0x56, 0x61, 0x75, 0x6c, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1d, 0x73, 0x76, 0x63,
	0x55, 0x73, 0x65, 0x72, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x50,
	0x61, 0x74, 0x68, 0x49, 0x6e, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x2a, 0x4d, 0x0a, 0x0a, 0x53, 0x74,
	...
	0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x03, 0x32, 0xc7, 0x02, 0x0a, 0x0a, 0x63, 0x61,
	0x70, 0x74, 0x65, 0x6e, 0x5f, 0x73, 0x64, 0x6b, 0x12, 0x64, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x47,
	0x69, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x79, 0x49, 0x64, 0x12, 0x25, 0x2e,
	0x63, 0x61, 0x70, 0x74, 0x65, 0x6e, 0x73, 0x64, 0x6b, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x47,
	0x69, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71,
	...
	0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x79,
	0x0a, 0x18, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x52, 0x65,
	0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x42, 0x79, 0x49, 0x64, 0x12, 0x2c, 0x2e, 0x63, 0x61, 0x70,
	...
	,
...
var file_capten_sdk_proto_goTypes = []interface{}{
	...
	(*SetupDatabaseRequest)(nil),             // 7: captensdkpb.SetupDatabaseRequest
	(*SetupDatabaseResponse)(nil),            // 8: captensdkpb.SetupDatabaseResponse
...
var file_capten_sdk_proto_depIdxs = []int32{
	...
	0, // 5: captensdkpb.SetupDatabaseResponse.status:type_name -> captensdkpb.StatusCode
	...
	7, // 8: captensdkpb.capten_sdk.SetupDatabase:input_type -> captensdkpb.SetupDatabaseRequest
	...
	8, // 11: captensdkpb.capten_sdk.SetupDatabase:output_type -> captensdkpb.SetupDatabaseResponse
...
func file_capten_sdk_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_capten_sdk_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetupDatabaseRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_capten_sdk_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetupDatabaseResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
