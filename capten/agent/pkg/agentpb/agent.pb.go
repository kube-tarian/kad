...
var file_agent_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x22, 0xf3, 0x03, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x61, 0x6c, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x5b, 0x0a, 0x09, 0x41, 0x70, 0x70,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xd1, 0x01, 0x0a, 0x0f, 0x41, 0x70, 0x70, 0x4c, 0x61,
	0x75, 0x6e, 0x63, 0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x20, 0x0a, 0x0b, 0x72, 0x65,
	0x6c, 0x65, 0x61, 0x73, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x72, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08,
	...
	0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12, 0x1c,
	0x0a, 0x09, 0x6c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x55, 0x52, 0x4c, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x6c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x55, 0x52, 0x4c, 0x12, 0x2c, 0x0a, 0x11,
	0x6c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x52, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x55, 0x52,
	0x4c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x6c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x52,
	0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x55, 0x52, 0x4c, 0x2a, 0x4e, 0x0a, 0x0a, 0x53, 0x74,
	...
	0x4f, 0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x03, 0x32, 0xc6, 0x0b, 0x0a, 0x05, 0x41,
	...
	0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x09, 0x53,
	0x75, 0x62, 0x6d, 0x69, 0x74, 0x4a, 0x6f, 0x62, 0x12, 0x13, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74,
	0x70, 0x62, 0x2e, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e,
...
var file_agent_proto_depIdxs = []int32{
	...
	1,  // 19: agentpb.Agent.Ping:input_type -> agentpb.PingRequest
	14, // 20: agentpb.Agent.SubmitJob:input_type -> agentpb.JobRequest
	3,  // 21: agentpb.Agent.StoreCredential:input_type -> agentpb.StoreCredentialRequest
	5,  // 22: agentpb.Agent.ClimonAppInstall:input_type -> agentpb.ClimonInstallRequest
	6,  // 23: agentpb.Agent.ClimonAppDelete:input_type -> agentpb.ClimonDeleteRequest
	7,  // 24: agentpb.Agent.DeployerAppInstall:input_type -> agentpb.ApplicationInstallRequest
	8,  // 25: agentpb.Agent.DeployerAppDelete:input_type -> agentpb.ApplicationDeleteRequest
	9,  // 26: agentpb.Agent.ClusterAdd:input_type -> agentpb.ClusterRequest
	9,  // 27: agentpb.Agent.ClusterDelete:input_type -> agentpb.ClusterRequest
	10, // 28: agentpb.Agent.RepositoryAdd:input_type -> agentpb.RepositoryAddRequest
	11, // 29: agentpb.Agent.RepositoryDelete:input_type -> agentpb.RepositoryDeleteRequest
	12, // 30: agentpb.Agent.ProjectAdd:input_type -> agentpb.ProjectAddRequest
	13, // 31: agentpb.Agent.ProjectDelete:input_type -> agentpb.ProjectDeleteRequest
	16, // 32: agentpb.Agent.SyncApp:input_type -> agentpb.SyncAppRequest
	18, // 33: agentpb.Agent.GetClusterApps:input_type -> agentpb.GetClusterAppsRequest
	20, // 34: agentpb.Agent.GetClusterAppLaunches:input_type -> agentpb.GetClusterAppLaunchesRequest
	22, // 35: agentpb.Agent.ConfigureAppSSO:input_type -> agentpb.ConfigureAppSSORequest
	24, // 36: agentpb.Agent.GetClusterAppConfig:input_type -> agentpb.GetClusterAppConfigRequest
	26, // 37: agentpb.Agent.GetClusterAppValues:input_type -> agentpb.GetClusterAppValuesRequest
	2,  // 38: agentpb.Agent.Ping:output_type -> agentpb.PingResponse
	15, // 39: agentpb.Agent.SubmitJob:output_type -> agentpb.JobResponse
	4,  // 40: agentpb.Agent.StoreCredential:output_type -> agentpb.StoreCredentialResponse
	15, // 41: agentpb.Agent.ClimonAppInstall:output_type -> agentpb.JobResponse
	15, // 42: agentpb.Agent.ClimonAppDelete:output_type -> agentpb.JobResponse
	15, // 43: agentpb.Agent.DeployerAppInstall:output_type -> agentpb.JobResponse
	15, // 44: agentpb.Agent.DeployerAppDelete:output_type -> agentpb.JobResponse
	15, // 45: agentpb.Agent.ClusterAdd:output_type -> agentpb.JobResponse
	15, // 46: agentpb.Agent.ClusterDelete:output_type -> agentpb.JobResponse
	15, // 47: agentpb.Agent.RepositoryAdd:output_type -> agentpb.JobResponse
	15, // 48: agentpb.Agent.RepositoryDelete:output_type -> agentpb.JobResponse
	15, // 49: agentpb.Agent.ProjectAdd:output_type -> agentpb.JobResponse
	15, // 50: agentpb.Agent.ProjectDelete:output_type -> agentpb.JobResponse
	17, // 51: agentpb.Agent.SyncApp:output_type -> agentpb.SyncAppResponse
	19, // 52: agentpb.Agent.GetClusterApps:output_type -> agentpb.GetClusterAppsResponse
	21, // 53: agentpb.Agent.GetClusterAppLaunches:output_type -> agentpb.GetClusterAppLaunchesResponse
	23, // 54: agentpb.Agent.ConfigureAppSSO:output_type -> agentpb.ConfigureAppSSOResponse
	25, // 55: agentpb.Agent.GetClusterAppConfig:output_type -> agentpb.GetClusterAppConfigResponse
	27, // 56: agentpb.Agent.GetClusterAppValues:output_type -> agentpb.GetClusterAppValuesResponse
