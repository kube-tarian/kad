...
func formUpdateKvPairsForGitProject(config *captenpluginspb.GitProject) (kvPairs string, emptyUpdate bool) {
	...
	if len(config.Labels) > 0 {
		params = append(params,
			fmt.Sprintf("labels = '%v'", strings.Join(config.Labels, ",")))
	}
