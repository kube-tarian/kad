...
func (c *agentClient) GetTektonProjectApp(ctx context.Context, in *GetTektonProjectRequest, opts ...grpc.CallOption) (*GetTektonProjectResponse, error) {
	out := new(GetTektonProjectResponse)
	err := c.cc.Invoke(ctx, Agent_GetTektonProjectApp_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Agent_GetTektonProjectApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTektonProjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).GetTektonProjectApp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_GetTektonProjectApp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).GetTektonProjectApp(ctx, req.(*GetTektonProjectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
