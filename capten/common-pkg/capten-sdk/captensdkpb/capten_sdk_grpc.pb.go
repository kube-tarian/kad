...
const (
	CaptenSdk_GetGitProjectById_FullMethodName        = "/captensdkpb.capten_sdk/GetGitProjectById"
	CaptenSdk_GetContainerRegistryById_FullMethodName = "/captensdkpb.capten_sdk/GetContainerRegistryById"
	CaptenSdk_SetupDatabase_FullMethodName            = "/captensdkpb.capten_sdk/SetupDatabase"
)
...
type CaptenSdkClient interface {
	...
	SetupDatabase(ctx context.Context, in *SetupDatabaseRequest, opts ...grpc.CallOption) (*SetupDatabaseResponse, error)
}
...
func (c *captenSdkClient) GetGitProjectById(ctx context.Context, in *GetGitProjectByIdRequest, opts ...grpc.CallOption) (*GetGitProjectByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, CaptenSdk_GetGitProjectById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *captenSdkClient) GetContainerRegistryById(ctx context.Context, in *GetContainerRegistryByIdRequest, opts ...grpc.CallOption) (*GetContainerRegistryByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, CaptenSdk_GetContainerRegistryById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *captenSdkClient) SetupDatabase(ctx context.Context, in *SetupDatabaseRequest, opts ...grpc.CallOption) (*SetupDatabaseResponse, error) {
	out := new(SetupDatabaseResponse)
	err := c.cc.Invoke(ctx, CaptenSdk_SetupDatabase_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CaptenSdkServer interface {
	...
	SetupDatabase(context.Context, *SetupDatabaseRequest) (*SetupDatabaseResponse, error)
...
func (UnimplementedCaptenSdkServer) SetupDatabase(context.Context, *SetupDatabaseRequest) (*SetupDatabaseResponse, error) {
...
func _CaptenSdk_GetGitProjectById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CaptenSdk_GetGitProjectById_FullMethodName,
	}
...
func _CaptenSdk_GetContainerRegistryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CaptenSdk_GetContainerRegistryById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CaptenSdk_SetupDatabase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CaptenSdk_SetupDatabase_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CaptenSdkServer).SetupDatabase(ctx, req.(*SetupDatabaseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
